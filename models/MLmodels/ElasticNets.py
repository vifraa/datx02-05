...
class ElasticNet:
    ...
    An object of this class can be instantiated in one of the following ways:
       ...
       * using path, ex: ElasticNet(path=GIVEN_PATH) then the constructor will read
       ...
       * using X and Y ex: ElasticNet(X=GIVEN_X, Y=GIVEN_Y) then the constructor will
       ...
       * if nothing of the above passed as argument ex. ElasticNet() then
    ...
    def mean_squared_error(self):
        return self.eNet_mean_squared_error

    def r2_score(self):
        return self.eNet_r2_score
    ...
    def save_the_trained_model(self):
        ...
        pickle.dump(self.eNet, open('simulator/api/'+filename, 'wb'))
